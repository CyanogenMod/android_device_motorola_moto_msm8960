...
#define WFC_UTIL_CFG_TEMPFILE_NAME      "/system/etc/firmware/wlan/prima/WCNSS_qcom_cfg.ini"
#endif
...
#define WFC_UTIL_NV_BIN_TEMPFILE_NAME   "/system/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv.bin"
#endif
